...
const {
  ...
  const checkRegisteredUser = (sender) => {
	  ...
	  const ownerNumber = [`6281313606860@s.whatsapp.net`]
  ...
  /*const reply = (teks) => {
			  xeon.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/6281313606860?text=hello`}}})
		  }*/
  ...
  const fakewa = (teks) => {        
  xeon.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Xeon`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/6281313606860?text=hello`}}})
		  }
  ...
  "externalAdReply": {
				  "title": `Whatsapp`,
				  "body": `wa.me/6281313606860`,
				  "mediaType": "10",
				  "mediaUrl": `wa.me/6281313606860`,
				  "thumbnailUrl": "https://i.ibb.co/y0RYgzB/FB-IMG-1635413002830.jpg",
				  "thumbnail": iye,
				  "sourceUrl": `wa.me/6281313606860`,
  ...
  async function sendFileFromUrl(from, url, caption, msg, men) {
	  ...
	  if (isGroup && !isVote) {
		if (budy.toLowerCase() === "vote") {
		  ...
		  let id_vote = sender ? sender : "6281313606860@s.whatsapp.net";
  ...
  *「 𝐃𝐨𝐠𝐞 𝐁𝐨𝐭 」*`
  ...
  groups = xeon.chats.array.filter(v => v.jid.endsWith('g.us'))
				...
				total = math(`${groups.length}*${privat.length}`)
  if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
		  ptod = "6281313606860@s.whatsapp.net"
		  dtod = '6281313606860'
		  stod = `${sender}`
		  uwuu = '```'
		  yoii = '*'
  ...
  case 'bugreport':
				...
				xeon.sendMessage('6281313606860@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
